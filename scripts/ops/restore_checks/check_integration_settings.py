...
from apps.platform.integrations.google.places import search_places  # noqa: E402 -- Django first
from apps.platform.integrations.models import IntegrationSettings  # noqa: E402
