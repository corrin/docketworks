...
Usage (once unblocked):
    uv run python -m scripts.ops.quote_import_harness --file "Quote.xlsx"
    uv run python -m scripts.ops.quote_import_harness --file "Quote.xlsx" --job-id <uuid>
    uv run python -m scripts.ops.quote_import_harness --file "Quote.xlsx" --preview-only
"""
