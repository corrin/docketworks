...
do_create() {
    ...
    [[ -z "${PHONE_CALL_DOWNLOADS_ENABLED:-}" ]] && MISSING+=("PHONE_CALL_DOWNLOADS_ENABLED")
    [[ -z "${PHONE_PROVIDER_RECORDING_DELETION_ENABLED:-}" ]] && MISSING+=("PHONE_PROVIDER_RECORDING_DELETION_ENABLED")
    ...
    [[ -z "${PHONE_OWN_NUMBERS:-}" ]] && MISSING+=("PHONE_OWN_NUMBERS")
...
BASH_PROFILE
    ...
    if [[ -f "$INSTANCE_DIR/.env" ]]; then
        ...
        local ESC_PHONE_CALL_DOWNLOADS_ENABLED ESC_PHONE_PROVIDER_RECORDING_DELETION_ENABLED
        local ESC_PHONE_PROVIDER_BASE_URL
        local ESC_PHONE_PROVIDER_USERNAME ESC_PHONE_PROVIDER_PASSWORD
        local ESC_PHONE_PROVIDER_ACCOUNT_CODE ESC_PHONE_OWN_NUMBERS
        ESC_PHONE_CALL_DOWNLOADS_ENABLED="$(sed_escape "$PHONE_CALL_DOWNLOADS_ENABLED")"
        ESC_PHONE_PROVIDER_RECORDING_DELETION_ENABLED="$(sed_escape "$PHONE_PROVIDER_RECORDING_DELETION_ENABLED")"
        ESC_PHONE_PROVIDER_BASE_URL="$(sed_escape "$PHONE_PROVIDER_BASE_URL")"
        ...
        ESC_PHONE_OWN_NUMBERS="$(sed_escape "$PHONE_OWN_NUMBERS")"
        ...
        sed \
            ...
            -e "s|__PHONE_CALL_DOWNLOADS_ENABLED__|$ESC_PHONE_CALL_DOWNLOADS_ENABLED|g" \
            -e "s|__PHONE_PROVIDER_RECORDING_DELETION_ENABLED__|$ESC_PHONE_PROVIDER_RECORDING_DELETION_ENABLED|g" \
            -e "s|__PHONE_PROVIDER_BASE_URL__|$ESC_PHONE_PROVIDER_BASE_URL|g" \
            ...
            -e "s|__PHONE_OWN_NUMBERS__|$ESC_PHONE_OWN_NUMBERS|g" \
