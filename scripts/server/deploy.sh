...
SERVER_SETUP_INPUTS=(
    ...
    "$SCRIPT_DIR/templates/nginx-ratelimit.conf"
    "$SCRIPT_DIR/templates/fail2ban-jail-docketworks.conf"
    "$SCRIPT_DIR/templates/fail2ban-filter-docketworks-auth-login.conf"
    "$SCRIPT_DIR/templates/fail2ban-filter-docketworks-auth-refresh.conf"
    "$SCRIPT_DIR/templates/nginx-instance.conf.template"
