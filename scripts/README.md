...
- **`verify_scrubbed_backup.py`** — Fail-closed verifier for scrubbed custom-format PostgreSQL archives. Reports table row counts only; never emits credential values.
