...
> 179 notes · 0 decisions · 10 open questions · 2026-02-24 → 2026-04-16

> **AI Primer:** This knowledge base spans 2026-02-24 to 2026-04-16 (179 notes). Key topics: verification, tips, steps, what youll need. 10 open questions remain.
...
## People
@docketworks · @transaction · @pytest · @patch · @morrissheetmetal · @dataclass · @extend_schema · @playwright · @tailwindcss · @vitejs · @cmeconnect · @require_superuser · @can_manage_timesheets · @property · @staticmethod · @vulcansteel · @coregas · @xtra · @vodafone · @fluidandgeneral
...
### General Notes (144)
- `docs/plans/2026-04-16-workshop-report.md` — 2026-04-16 — Office staff need to manage customer delivery expectations. Currently there is no way to see
