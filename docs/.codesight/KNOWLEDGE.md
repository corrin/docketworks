...
> 111 notes · 18 decisions · 10 open questions · 2026-04-16 → 2026-04-28

> **AI Primer:** This knowledge base spans 2026-04-16 to 2026-04-28 (111 notes). Key topics: alternatives considered, tips, steps, what youll need. Most recent decision: Introduce `AlreadyLoggedException` in `apps/workflow/exceptions.py` that wraps an original exception plus the `AppError.…. 10 open questions remain.
