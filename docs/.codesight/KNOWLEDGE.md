...
> 121 notes · 19 decisions · 10 open questions

> **AI Primer:** This knowledge base has 121 notes. Key topics: problem, why, alternatives considered, verification. Most recent decision: `AlreadyLoggedException` (in `apps/workflow/exceptions.py`) wraps the original exception plus the persisted `AppError.id…. 10 open questions remain.
...
## People
@login_required · @docketworks · @pytest · @verify · @shared_task · @staticmethod · @democompany · @update · @github · @bairdandwhyte · @vue · @deprecated · @latest · @playwright · @staff_member_required · @input · @change · @blur · @dataclass · @ljharb
...
### General Notes (96)
- `docs/plans/2026-05-09-xero-state-validation-suite.md` — 2026-05-09 — Trello #305 (the snake_case payload bug) exposed a class of bug the current test surface is structurally blind to: outbound calls return `200 OK`, the UI update…
