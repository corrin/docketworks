...
> 170 notes · 15 decisions · 10 open questions · 2026-02-24 → 2026-04-25

> **AI Primer:** This knowledge base spans 2026-02-24 to 2026-04-25 (170 notes). Key topics: verification, tips, alternatives considered, what youll need. Most recent decision: Introduce `AlreadyLoggedException` in `apps/workflow/exceptions.py` that wraps an original exception plus the `AppError.…. 10 open questions remain.
...
## People
@login_required · @extend_schema · @docketworks · @morrissheetmetal · @msm · @transaction · @pytest · @patch · @anthropic · @classmethod · @rowClick · @resolve · @unresolve · @update · @close · @api_view · @permission_classes · @click · @staticmethod · @property
...
- `docs/plans/2026-04-25-delivery-docket-staff-fk.md` — **2** incoming references — Delivery docket print: missing staff FK on JobEvent + dev logo setup
...
### Specs & PRDs (18)
- `docs/plans/2026-04-25-pdf-golden-tests-design.md` — 2026-04-25 ← 1 refs — Design spec for byte-identical regression tests covering the two user-facing
...
### General Notes (135)
- `docs/plans/2026-04-25-delivery-docket-staff-fk.md` — 2026-04-25 ← 2 refs — **Filename note:** The plan-mode harness pre-assigned `we-have-a-bug-jolly-codd.md`,
- `docs/plans/2026-04-25-fix-delivery-dockets-implementation.md` — 2026-04-25 — **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan tas…
