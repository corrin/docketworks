...
> 123 notes · 19 decisions · 10 open questions · 2026-05-09 → 2026-05-09

> **AI Primer:** This knowledge base spans 2026-05-09 to 2026-05-09 (123 notes). Key topics: verification, problem, why, alternatives considered. Most recent decision: `AlreadyLoggedException` (in `apps/workflow/exceptions.py`) wraps the original exception plus the persisted `AppError.id…. 10 open questions remain.
...
## Recurring Themes
verification · problem · why · alternatives considered · tips · what youll need · steps · what happens next · out of scope · approach · files to modify · critical files

## People
@login_required · @docketworks · @pytest · @shared_task · @staticmethod · @democompany · @update · @github · @bairdandwhyte · @vue · @deprecated · @latest · @playwright · @staff_member_required · @input · @change · @blur · @dataclass · @ljharb · @mhart
...
### General Notes (98)
- `docs/plans/2026-05-09-309-seed-xero-prod-guard-machine-id.md` — 2026-05-09 — `apps/workflow/management/commands/seed_xero_from_database.py:916-931` (method `clear_production_xero_ids`) gates "am I production?" with a substring sniff on t…
- `docs/plans/2026-05-09-xero-reconciler-end-of-e2e.md` — 2026-05-09 — A full Playwright E2E run exercises dozens of Xero pushes — contacts, quotes, invoices, POs, updates — across many UI flows. After all of that is done, the ques…
