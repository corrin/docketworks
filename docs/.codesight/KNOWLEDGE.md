...
> 122 notes · 19 decisions · 10 open questions

> **AI Primer:** This knowledge base has 122 notes. Key topics: verification, problem, why, alternatives considered. Most recent decision: `AlreadyLoggedException` (in `apps/workflow/exceptions.py`) wraps the original exception plus the persisted `AppError.id…. 10 open questions remain.
