...
> 147 notes · 14 decisions · 10 open questions · 2026-02-24 → 2026-04-19

> **AI Primer:** This knowledge base spans 2026-02-24 to 2026-04-19 (147 notes). Key topics: tips, alternatives considered, verification, what youll need. Most recent decision: Introduce `AlreadyLoggedException` in `apps/workflow/exceptions.py` that wraps an original exception plus the `AppError.…. 10 open questions remain.
...
## Recurring Themes
tips · alternatives considered · verification · what youll need · steps · what happens next · troubleshooting · files to modify · purpose · prerequisites · design · project overview
