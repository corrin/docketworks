...
> 162 notes · 15 decisions · 10 open questions · 2026-02-24 → 2026-04-22

> **AI Primer:** This knowledge base spans 2026-02-24 to 2026-04-22 (162 notes). Key topics: verification, tips, alternatives considered, what youll need. Most recent decision: Introduce `AlreadyLoggedException` in `apps/workflow/exceptions.py` that wraps an original exception plus the `AppError.…. 10 open questions remain.
...
## Recurring Themes
verification · tips · alternatives considered · what youll need · files to modify · steps · what happens next · troubleshooting · approach · critical files · purpose · prerequisites
