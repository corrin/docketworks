...
> 102 notes · 14 decisions · 10 open questions

> **AI Primer:** This knowledge base has 102 notes. Key topics: tips, alternatives considered, what youll need, steps. Most recent decision: Introduce `AlreadyLoggedException` in `apps/workflow/exceptions.py` that wraps an original exception plus the `AppError.…. 10 open questions remain.
...
## Recurring Themes
tips · alternatives considered · what youll need · steps · what happens next · troubleshooting · prerequisites · purpose · development workflow · license · step 1 prepare credentials · step 2 create instance
