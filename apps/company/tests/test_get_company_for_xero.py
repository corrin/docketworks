"""Tests for Company.get_company_for_xero().
...
class GetCompanyForXeroTests(TestCase):
    ...
    def test_existing_company_populates_contact_id_on_instance(self):
        ...
        (`contact_data["ContactID"] = company.xero_contact_id`).
        """
        xero_id = "9568adbc-aaaa-bbbb-cccc-000000000001"
        company = self._make_company(xero_contact_id=xero_id)
    ...
    def test_no_email_emits_none_not_empty_string(self):
        ...
        """
        company = self._make_company(email=None)
    ...
    def test_serialized_wire_format_is_pascalcase(self):
        ...
        wire = serialize(company.get_company_for_xero())
