...
def _create_stock_from_allocation(
    ...
    stock = Stock.objects.create(
        ...
        metal_type=metadata.get("metal_type", line.metal_type) or None,
        alloy=metadata.get("alloy", line.alloy) or None,
        specifics=metadata.get("specifics", line.specifics) or None,
        location=metadata.get("location", line.location) or None,
        date=timezone.now(),
