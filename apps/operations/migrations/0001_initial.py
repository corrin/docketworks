    ...
    operations = [
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("failure_reason", ""), _negated=True),
                        name="failure_reason_not_blank",
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("unscheduled_reason", ""), _negated=True),
                        name="unscheduled_reason_not_blank",
                    )
                ],
