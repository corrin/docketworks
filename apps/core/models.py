...
install-level credentials belong to platform.integrations (ADR 0055).
``AppError.session_replay`` uses a string
...
class CompanyDefaults(SingletonModel):
    ...
    # (apps.platform.integrations.google.places.nz_subdivision_for_region), and
