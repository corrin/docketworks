            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("app", ""), _negated=True),
                        name="app_not_blank",
                    ),
                    models.CheckConstraint(
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("function", ""), _negated=True),
                        name="function_not_blank",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("address_line1", ""), _negated=True),
                        name="address_line1_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("address_line2", ""), _negated=True),
                        name="address_line2_not_blank",
                    ),
                    models.CheckConstraint(
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("company_acronym", ""), _negated=True),
                        name="company_acronym_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("company_email", ""), _negated=True),
                        name="company_email_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("company_url", ""), _negated=True),
                        name="company_url_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("gdrive_how_we_work_folder_id", ""), _negated=True),
                        name="gdrive_how_we_work_folder_id_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("gdrive_quotes_folder_id", ""), _negated=True),
                        name="gdrive_quotes_folder_id_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("gdrive_quotes_folder_url", ""), _negated=True),
                        name="gdrive_quotes_folder_url_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("gdrive_reference_library_folder_id", ""), _negated=True
                        ),
                        name="gdrive_reference_library_folder_id_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("gdrive_sops_folder_id", ""), _negated=True),
                        name="gdrive_sops_folder_id_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("google_shared_drive_id", ""), _negated=True),
                        name="google_shared_drive_id_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("master_quote_template_id", ""), _negated=True),
                        name="master_quote_template_id_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("master_quote_template_url", ""), _negated=True),
                        name="master_quote_template_url_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("post_code", ""), _negated=True),
                        name="post_code_not_blank",
                    ),
                    models.CheckConstraint(
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("test_company_name", ""), _negated=True),
                        name="test_company_name_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("xero_shortcode", ""), _negated=True),
                        name="xero_shortcode_not_blank",
                    ),
                    models.CheckConstraint(
