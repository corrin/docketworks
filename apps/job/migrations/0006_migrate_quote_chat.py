...
def migrate_messages(apps: StateApps, _schema_editor: BaseDatabaseSchemaEditor) -> None:
...
def reverse_empty_database(apps: StateApps, _schema_editor: BaseDatabaseSchemaEditor) -> None:
