...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="job",
            index=models.Index(fields=["status", "priority"], name="job_priority_status_idx"),
        ),
        migrations.AddConstraint(
            model_name="job",
            constraint=models.CheckConstraint(
                condition=models.Q(("description", ""), _negated=True),
                name="job_job_description_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="job",
            constraint=models.CheckConstraint(
                ...
                name="job_job_notes_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="job",
            constraint=models.CheckConstraint(
                condition=models.Q(("order_number", ""), _negated=True),
                name="order_number_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="job",
            constraint=models.CheckConstraint(
                condition=models.Q(("rdti_type", ""), _negated=True),
                name="rdti_type_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="job",
            constraint=models.CheckConstraint(
                condition=models.Q(("xero_default_task_id", ""), _negated=True),
        ...
        migrations.AddConstraint(
            model_name="job",
            constraint=models.CheckConstraint(
                condition=models.Q(("xero_project_id", ""), _negated=True),
                name="xero_project_id_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="costset",
        ...
        migrations.AddIndex(
            model_name="jobdeltarejection",
            index=models.Index(fields=["-created_at"], name="job_delta_rej_created_idx"),
        ),
        migrations.AddIndex(
            model_name="jobdeltarejection",
            index=models.Index(fields=["resolved", "reason"], name="job_delta_rej_res_rsn_idx"),
        ),
        migrations.AddConstraint(
            model_name="jobdeltarejection",
            constraint=models.CheckConstraint(
                condition=models.Q(("checksum", ""), _negated=True),
                name="checksum_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="jobdeltarejection",
            constraint=models.CheckConstraint(
                ...
                name="detail_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="jobdeltarejection",
            constraint=models.CheckConstraint(
                condition=models.Q(("request_etag", ""), _negated=True),
                name="request_etag_not_blank",
            ),
        ),
        migrations.AddIndex(
            model_name="jobevent",
            index=models.Index(fields=["job", "-timestamp"], name="jobevent_job_timestamp_idx"),
        ),
        migrations.AddIndex(
            model_name="jobevent",
            index=models.Index(
        ...
        migrations.AddIndex(
            model_name="jobevent",
            index=models.Index(fields=["staff", "-timestamp"], name="jobevent_staff_timestamp_idx"),
        ),
        migrations.AddIndex(
            model_name="jobevent",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                ...
                name="dedup_hash_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="jobevent",
            constraint=models.CheckConstraint(
                condition=models.Q(("delta_checksum", ""), _negated=True),
                name="delta_checksum_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="jobfile",
            constraint=models.CheckConstraint(
                ...
                name="job_jobfile_mime_type_not_blank",
            ),
        ),
        migrations.AddIndex(
            model_name="jobquotechat",
            index=models.Index(fields=["job", "timestamp"], name="job_jobquot_job_id_c83a63_idx"),
        ),
        migrations.AddIndex(
            model_name="jobquotechat",
            index=models.Index(fields=["message_id"], name="job_jobquot_message_786ba1_idx"),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name="costline",
            constraint=models.CheckConstraint(
                condition=models.Q(("desc", ""), _negated=True), name="desc_not_blank"
            ),
        ),
        migrations.AddConstraint(
            model_name="costline",
            constraint=models.CheckConstraint(
                condition=models.Q(("xero_expense_id", ""), _negated=True),
                name="xero_expense_id_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="costline",
            constraint=models.CheckConstraint(
                condition=models.Q(("xero_time_id", ""), _negated=True),
                name="xero_time_id_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="quotespreadsheet",
            constraint=models.CheckConstraint(
                condition=models.Q(("sheet_url", ""), _negated=True),
                name="sheet_url_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="quotespreadsheet",
            constraint=models.CheckConstraint(
                condition=models.Q(("tab", ""), _negated=True), name="tab_not_blank"
            ),
        ),
    ]
