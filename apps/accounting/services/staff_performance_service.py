...
company's — shop work never bills. Two quirks are ported as-is, and unifying
them is an owner decision nobody has asked for: total_revenue sums ALL lines
(shop included) even though
