        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("google_doc_id", ""), _negated=True),
                        name="google_doc_id_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("google_doc_url", ""), _negated=True),
                        name="google_doc_url_not_blank",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("site_location", ""), _negated=True),
                        name="site_location_not_blank",
                    ),
                ],
            },
        ),
