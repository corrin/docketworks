...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        self.PII_CONFIG = {
            ...
            # Xero invoice/bill/credit note raw_json contains client details
            "accounting.invoice": {
                "raw_json._contact._name": "company",
                "raw_json._contact._email_address": "email",
            },
            "accounting.bill": {
                "raw_json._contact._name": "company",
                "raw_json._contact._email_address": "email",
    ...
    def handle(self, *args, **options):
        ...
        # Exclude-list: everything NOT listed here is included in the backup.
        # New models are backed up by default — add here only if they should
        ...
        EXCLUDE_MODELS = [
            ...
            # Debug/operational data — not needed in dev
            "workflow.apperror",
            "workflow.xeroerror",
            # Scheduler state — not portable between environments
            "django_apscheduler.djangojob",
            "django_apscheduler.djangojobexecution",
            # SimpleHistory tables — large, and will be rebuilt by post-restore usage
            "accounts.historicalstaff",
            "job.historicaljob",
            "process.historicalform",
            "process.historicalformentry",
            "process.historicalprocedure",
        ]
        ...
        self.stdout.write(f"Models excluded: {', '.join(EXCLUDE_MODELS)}")
