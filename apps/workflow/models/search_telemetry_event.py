...
class SearchTelemetryEvent(models.Model):
    ...
    normalized_query = models.CharField(max_length=255, blank=True, null=True)
    ...
    selected_result_id = models.CharField(max_length=255, blank=True, null=True)
    selected_label = models.CharField(max_length=255, blank=True, null=True)
