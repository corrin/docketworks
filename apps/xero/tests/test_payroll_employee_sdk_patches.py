...
from apps.xero.payroll_employees import _reading_xero_response
...
class TestOutsideTheWindow:
    ...
    def test_an_employment_we_build_still_needs_an_engagement_type_check(self) -> None:
    ...
    def test_a_failure_inside_the_window_still_closes_it(self) -> None:
        ...
        with pytest.raises(RuntimeError, match="xero exploded"), _reading_xero_response():
    ...
    def test_nesting_does_not_strand_the_relaxation(self) -> None:
        with _reading_xero_response(), _reading_xero_response():
            pass
