...
def create_system_automation_user(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
...
def delete_system_automation_user(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    Staff = apps.get_model("accounts", "Staff")
