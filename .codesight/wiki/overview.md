...
95 API routes · 45 database models · 183 UI components · 11 middleware layers · 70 environment variables
...
**Database:** django, 45 models — see [database.md](./database.md)

**UI:** 183 components (vue) — see [ui.md](./ui.md)
