...
test.describe('Payroll Reconciliation Report', () => {
  test('loads and displays reconciliation data', async ({ authenticatedPage: page }) => {
    ...
    // Use FY 2025-2026 dates. The backend aligns the range to pay weeks and
    // clamps it to the instance's Xero payroll history; those semantics are
    // covered by backend unit tests (test_payroll_reconciliation_service.py),
