 ...
 *
 * Pins the full-stack contract for the server-side FTS endpoint:
 *
 ...
 * API, so the bug was invisible there. Only this E2E confirms the full
 * path — debounced input → axios → backend → JSON → table render —
