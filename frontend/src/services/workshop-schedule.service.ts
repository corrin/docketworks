...
const log = debug('workshop:schedule')
...
export const workshopScheduleService = {
  ...
  async unassignStaff(jobId: string, staffId: string): Promise<AssignJobResponse> {
    log('unassignStaff ->', { jobId, staffId })
