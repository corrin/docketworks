 ...
 * * `adjust` - Adjustment
 */
export const zCostLineKindEnum = z.enum(["time", "material", "adjust"]);
 ...
 * * `actual` - Actual
 */
export const zCostSetKindEnum = z.enum(["estimate", "quote", "actual"]);
 ...
 * * `stock` - Stock
 */
export const zDomainEnum = z.enum(["company", "kanban", "stock"]);
 ...
 * * `email` - email
 */
export const zDuplicatePersonContactMethodMethodTypeEnum = z.enum([
  "phone",
  "email",
]);
...
export const zFinishJobSummary = z.object({
  ...
  valid_invoiced_excl_gst: z
    .number()
    .gt(-10000000000)
    .lt(10000000000)
    .readonly(),
  outstanding_invoiced_incl_gst: z
    .number()
    .gt(-10000000000)
    .lt(10000000000)
    .readonly(),
  remaining_to_invoice_excl_gst: z
    .number()
    .gt(-10000000000)
    .lt(10000000000)
    .readonly(),
  remaining_gst: z.number().gt(-10000000000).lt(10000000000).readonly(),
  remaining_to_invoice_incl_gst: z
    .number()
    .gt(-10000000000)
    .lt(10000000000)
    .readonly(),
  total_to_pay_incl_gst: z.number().gt(-10000000000).lt(10000000000).readonly(),
  over_invoiced_excl_gst: z
    .number()
    .gt(-10000000000)
    .lt(10000000000)
    .readonly(),
...
export const zJobReorderRequest = z.object({
  ...
  placement: z.union([zPlacementEnum, zNullEnum]).nullish(),
 ...
 */
export const zPricingMethodologyEnum = z.enum([
  "time_materials",
  "fixed_price",
]);
...
export const zPurchaseOrderLine = z.object({
  ...
  metal_type: z.union([zMetalTypeEnum, zNullEnum]).nullish(),
 ...
 */
export const zRdtiTypeEnum = z.enum(["non_rd", "core_rd", "supporting_rd"]);
 ...
 */
export const zSpeedQualityTradeoffEnum = z.enum(["fast", "normal", "quality"]);
...
export const zJobHeaderResponse = z.object({
  ...
  rdti_type: z.union([zRdtiTypeEnum, zNullEnum]).nullish(),
...
export const zAccountingReportsJobMovementRetrieveResponse = z.record(
  z.string(),
  z.unknown(),
);
...
export const zAccountingReportsPayrollDateRangeRetrieveResponse =
  zPayrollDateRangeResponse;
...
export const zAccountingReportsPayrollReconciliationRetrieveResponse =
  zPayrollReconciliationResponse;
...
export const zAccountingReportsSalesPipelineRetrieveResponse =
  zSalesPipelineResponse;
...
export const zAccountingReportsStaffPerformanceSummaryRetrieveResponse =
  zStaffPerformanceResponse;
...
export const zAccountingReportsStaffPerformanceRetrieveResponse =
  zStaffPerformanceResponse;
...
export const zAppErrorsGroupedMarkResolvedCreateBody =
  zGroupedErrorResolveRequestRequest;

export const zAppErrorsGroupedMarkResolvedCreateResponse =
  zGroupedErrorResolveResponse;

export const zAppErrorsGroupedMarkUnresolvedCreateBody =
  zGroupedErrorResolveRequestRequest;

export const zAppErrorsGroupedMarkUnresolvedCreateResponse =
  zGroupedErrorResolveResponse;
...
export const zCompaniesPeoplePhoneOwnershipCreateBody =
  zPhoneOwnershipRequestRequest;
...
export const zCompaniesSupplierAliasesListResponse =
  z.array(zSupplierSearchAlias);

export const zCompaniesSupplierAliasesCreateBody =
  zSupplierSearchAliasCreateRequest;
...
export const zCompaniesContactMethodsPartialUpdateBody =
  zPatchedContactMethodRequest;
...
export const zCompaniesPickupAddressesListResponse = z.array(
  zSupplierPickupAddress,
);

export const zCompaniesPickupAddressesCreateBody =
  zSupplierPickupAddressRequest;
...
export const zCompaniesPickupAddressesPartialUpdateBody =
  zPatchedSupplierPickupAddressRequest;

export const zCompaniesPickupAddressesPartialUpdatePath = z.object({
  id: z.uuid(),
});

export const zCompaniesPickupAddressesPartialUpdateResponse =
  zSupplierPickupAddress;

export const zCompaniesPickupAddressesUpdateBody =
  zSupplierPickupAddressRequest;
...
export const zCompanyDefaultsPartialUpdateBody =
  zPatchedCompanyDefaultsRequestWritable;
...
export const zCompanyDefaultsUploadLogoCreateBody =
  zCompanyDefaultsRequestWritable;
...
export const zUpdatePhoneProviderSettingsBody =
  zPatchedPhoneProviderSettingsRequestWritable;
...
export const zJobCostLinesPartialUpdateBody =
  zPatchedCostLineCreateUpdateRequest;
...
export const zCheckArchivedJobsComplianceResponse =
  zArchivedJobsComplianceResponse;
...
export const zJobJobsCostSetsActualCostLinesCreateBody =
  zCostLineCreateUpdateRequest;
...
export const zJobRestJobDeltaRejectionsListResponse =
  zJobDeltaRejectionListResponse;
...
export const zJobJobsFinishPartialUpdateBody =
  zPatchedJobCompletionChecklistUpdateRequest;
...
export const zJobJobsLabourRatesPartialUpdateBody =
  zPatchedJobLabourRatesUpdateRequestRequest;
...
export const zJobJobsQuoteChatCreateResponse =
  zJobQuoteChatInteractionSuccessResponse;
...
export const zJobJobsQuoteChatPartialUpdateBody =
  zPatchedJobQuoteChatUpdateRequest;
...
export const zJobJobsQuoteChatInteractionCreateBody =
  zJobQuoteChatInteractionRequest;
 ...
 */
export const zJobJobsQuoteChatInteractionCreateResponse =
  zJobQuoteChatInteractionSuccessResponse;
...
export const zJobRestJobsDeltaRejectionsAdminListResponse =
  zJobDeltaRejectionListResponse;
...
export const zJobJobsDeltaRejectionsGroupedRetrieveResponse =
  zGroupedJobDeltaRejectionListResponse;

export const zJobJobsDeltaRejectionsGroupedMarkResolvedCreateBody =
  zGroupedJobDeltaRejectionResolveRequestRequest;

export const zJobJobsDeltaRejectionsGroupedMarkResolvedCreateResponse =
  zGroupedJobDeltaRejectionResolveResponse;

export const zJobJobsDeltaRejectionsGroupedMarkUnresolvedCreateBody =
  zGroupedJobDeltaRejectionResolveRequestRequest;

export const zJobJobsDeltaRejectionsGroupedMarkUnresolvedCreateResponse =
  zGroupedJobDeltaRejectionResolveResponse;
...
export const zJobLabourSubtypesManageListResponse =
  z.array(zLabourSubtypeManage);
...
export const zJobLabourSubtypesManagePartialUpdateBody =
  zPatchedLabourSubtypeManageRequest;

export const zJobLabourSubtypesManagePartialUpdatePath = z.object({
  id: z.uuid(),
});

export const zJobLabourSubtypesManagePartialUpdateResponse =
  zLabourSubtypeManage;
...
export const zJobTimesheetEntriesRetrieveResponse =
  zModernTimesheetEntryGetResponse;

export const zJobTimesheetEntriesCreateBody = zModernTimesheetEntryPostRequest;

export const zJobTimesheetEntriesCreateResponse =
  zModernTimesheetEntryPostResponse;
...
export const zJobTimesheetStaffDateRetrieveResponse =
  zModernTimesheetDayGetResponse;
...
export const zJobWorkshopTimesheetsRetrieveResponse =
  zWorkshopTimesheetListResponse;

export const zJobWorkshopTimesheetsPartialUpdateBody =
  zPatchedWorkshopTimesheetEntryUpdateRequest;

export const zJobWorkshopTimesheetsPartialUpdateResponse =
  zWorkshopTimesheetEntry;

export const zJobWorkshopTimesheetsCreateBody =
  zWorkshopTimesheetEntryRequestRequest;
...
export const zOperationsWorkshopScheduleRetrieveResponse =
  zWorkshopScheduleResponse;

export const zOperationsWorkshopScheduleRecalculateCreateQuery = z.object({
  day_horizon: z.int().optional(),
});

export const zOperationsWorkshopScheduleRecalculateCreateResponse =
  zWorkshopScheduleResponse;
...
export const zPeopleContactMethodsPartialUpdateBody =
  zPatchedPersonContactMethodWriteRequest;
...
export const zProcessProceduresPartialUpdateBody =
  zPatchedProcedureUpdateRequest;
...
export const zProcessProceduresContentRetrieveResponse =
  zProcedureContentResponse;

export const zProcessProceduresContentUpdateBody =
  zProcedureContentUpdateRequest;
...
export const zProcessProceduresSafetyGenerateSopCreateBody =
  zSopGenerateRequestRequest;

export const zProcessProceduresSafetyGenerateSopCreateResponse =
  zProcedureDetail;

export const zProcessProceduresSafetyGenerateSwpCreateBody =
  zSwpGenerateRequestRequest;

export const zProcessProceduresSafetyGenerateSwpCreateResponse =
  zProcedureDetail;

export const zProcessSafetyAiGenerateControlsCreateBody =
  zGenerateControlsRequestRequest;

export const zProcessSafetyAiGenerateControlsCreateResponse =
  zGenerateControlsResponse;

export const zProcessSafetyAiGenerateHazardsCreateBody =
  zGenerateHazardsRequestRequest;

export const zProcessSafetyAiGenerateHazardsCreateResponse =
  zGenerateHazardsResponse;

export const zProcessSafetyAiImproveDocumentCreateBody =
  zImproveDocumentRequestRequest;

export const zProcessSafetyAiImproveDocumentCreateResponse =
  zImproveDocumentResponse;

export const zProcessSafetyAiImproveSectionCreateBody =
  zImproveSectionRequestRequest;

export const zProcessSafetyAiImproveSectionCreateResponse =
  zImproveSectionResponse;
...
export const zPurchasingDeliveryReceiptsCreateResponse =
  zDeliveryReceiptResponse;
...
export const zPurchasingPurchaseOrdersPartialUpdateBody =
  zPatchedPurchaseOrderUpdateRequest;

export const zPurchasingPurchaseOrdersPartialUpdatePath = z.object({
  po_id: z.uuid(),
});

export const zPurchasingPurchaseOrdersPartialUpdateResponse =
  zPurchaseOrderUpdate;

export const zPurchasingPurchaseOrdersAllocationsRetrievePath = z.object({
  po_id: z.uuid(),
});

export const zPurchasingPurchaseOrdersAllocationsRetrieveResponse =
  zPurchaseOrderAllocationsResponse;
...
export const zCreatePurchaseOrderEventResponse =
  zPurchaseOrderEventCreateResponse;
...
export const zGetLastPurchaseOrderNumberResponse =
  zPurchaseOrderLastNumberResponse;
...
export const zPurchasingSuppliersSearchRetrieveResponse =
  zSupplierSearchResponse;
...
export const zQuotingScheduledTaskExecutionsListResponse =
  zPaginatedScheduledTaskExecutionList;

export const zQuotingScheduledTaskExecutionsRetrievePath = z.object({
  id: z.int(),
});

export const zQuotingScheduledTaskExecutionsRetrieveResponse =
  zScheduledTaskExecution;
...
export const zSessionReplayFrontendErrorsCreateBody =
  zSessionReplayFrontendErrorRequest;

export const zSessionReplayFrontendErrorsCreateResponse =
  zSessionReplayFrontendErrorResponse;
...
export const zSessionReplayRecordingsCreateBody =
  zSessionReplayRecordingCreateRequest;
...
export const zSessionReplayRecordingChunksCreateBody =
  zSessionReplayChunkCreateRequest;
...
export const zSessionReplayRecordingEventsRetrieveResponse =
  zSessionReplayEventsResponse;
...
export const zTimesheetsPayrollPayRunsCreateCreateResponse =
  zCreatePayRunResponse;

export const zTimesheetsPayrollPayRunsRefreshCreateResponse =
  zPayRunSyncResponse;

export const zTimesheetsPayrollPostStaffWeekCreateBody = zPostWeekToXeroRequest;

export const zTimesheetsPayrollPostStaffWeekCreateResponse =
  zPostWeekToXeroStartResponse;
...
export const zGetStaffDailyTimesheetDetailByDateResponse =
  zDailyTimesheetSummary;
...
export const zWorkflowAiProvidersCreateBody =
  zAiProviderCreateUpdateRequestWritable;
...
export const zWorkflowAiProvidersPartialUpdateBody =
  zPatchedAiProviderCreateUpdateRequestWritable;

export const zWorkflowAiProvidersPartialUpdatePath = z.object({
  id: z.int(),
});

export const zWorkflowAiProvidersPartialUpdateResponse =
  zAiProviderCreateUpdate;

export const zWorkflowAiProvidersUpdateBody =
  zAiProviderCreateUpdateRequestWritable;
...
export const zWorkflowNotebookLmLinksPartialUpdateBody =
  zPatchedNotebookLmLinkRequest;
...
export const zWorkflowNotebookLmLinksMenuListResponse =
  z.array(zNotebookLmLink);
...
export const zWorkflowXeroAppsPartialUpdateBody =
  zPatchedXeroAppRequestWritable;
...
export const zXeroErrorsGroupedMarkResolvedCreateBody =
  zGroupedErrorResolveRequestRequest;

export const zXeroErrorsGroupedMarkResolvedCreateResponse =
  zGroupedErrorResolveResponse;

export const zXeroErrorsGroupedMarkUnresolvedCreateBody =
  zGroupedErrorResolveRequestRequest;

export const zXeroErrorsGroupedMarkUnresolvedCreateResponse =
  zGroupedErrorResolveResponse;
...
export const zXeroCreatePurchaseOrderCreateResponse =
  zXeroDocumentSuccessResponse;
...
export const zXeroDeletePurchaseOrderDestroyResponse =
  zXeroDocumentSuccessResponse;
