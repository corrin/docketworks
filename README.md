...
A full rewrite of v1, which it replaced in production on 29 August 2026; the deliberate
behaviour differences are in [`docs/accepted-api-differences.yml`](docs/accepted-api-differences.yml).
